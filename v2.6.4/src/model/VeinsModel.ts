...
export const MessageTypes = {
    ...
    XFER_WORKSPACE: 2,
    XFER_ROOM: 3,
    XFER_ROOM_IN_WORKSPACE: 4,
    XFER_USER: 5,
    XFER_USER_IN_WORKSPACE: 6,
    XFER_USER_IN_ROOM: 7
} as { [k: string]: MessageType }

export interface VeinsMessage {
    t: MessageType // type
    b: string // message body
    l?: VeinsPhoneLine // line
    w?: number // workspaceID
    r?: number // roomID
    c?: string // channel
    o?: string // contact
}

export type VeinsReceivedMessageType = 1 | 2 | 3 | 4 | 5 | 6 | 7

export const VeinsReceivedMessageTypes = {
    OUTGOING_CHANNEL: 1,
    PARKSLOT_USER_RESERVED: 2,
    PARKSLOT_ROOM_RESERVED: 3,
    PARKSLOT_WORKSPACE_RESERVED: 4,
    PARKSLOT_USER_CHANGE: 5,
    PARKSLOT_ROOM_CHANGE: 6,
    PARKSLOT_WORKSPACE_CHANGE: 7,
} as { [k: string]: VeinsReceivedMessageType }

export interface VeinsReceivedMessage {
    type: VeinsReceivedMessageType,
    channel?: string
    contact?: string
    parkslots?: string
    reserved_parkslot_num?: string
    message?: VeinsMessage
}
...
export type VeinsParkslot = {
    c: string // channel name
    i: string // extra info in json string
    n: boolean // is new parkslot or not
}

export type VeinsParkslots = {
    [parkslot: string]: VeinsParkslot
}

export type VeinsParkslotsURW = {
    u: VeinsParkslots
    r: VeinsParkslots
    w: VeinsParkslots
}

export type VeinsReservedParkslot = {
    [parkslot: string]: {
        slot: VeinsParkslot
        message: VeinsMessage
    }
...
export type VeinsEventPhoneOnParkslotsRefreshed = {
    id: string
    oldSlots: VeinsParkslotsURW
    newSlots: VeinsParkslotsURW
}

export type VeinsEventPhoneOnParkslotsChange = {
    id: string
    oldSlots: VeinsParkslotsURW
    newSlots: VeinsParkslotsURW
}
